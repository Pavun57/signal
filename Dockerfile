...
# env vars to the container only). Every NEXT_PUBLIC_* var the app or the
# Clerk SDK reads must therefore be a build ARG mapped to ENV here, and set
# under Dokploy's build arguments (in addition to the Environment section).
